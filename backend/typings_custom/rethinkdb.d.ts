...
declare module "rethinkdb" {
  ...
  export function tableDrop(name:string):Operation<DropResult>;
  export function tableList():Operation<string[]>;
  export function table(name:string, options?:GetTableOptions):Table;
  ...
  interface Table extends Sequence {
    ...
    indexWait(name:string):Operation<CreateResult>;
